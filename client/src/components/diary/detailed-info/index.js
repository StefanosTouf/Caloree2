  ...
  const renderProgressBars = () => {
    ...
    if (_.isEmpty(targetsAchieved)) {
      ...
      for (let key of Object.keys(userTargets)) {
        const achievedAmount = targetsAchieved[key]
          ? targetsAchieved[key].amount
          : 0;

        {
          userTargets[key].amount
            ? ar.push(
                  ...
                  <div className="ui green inverted progress">
                    ...
                    <div className="bar-wrapper">
                      <div
                        ...
                        style={{
                          width: `${
                            (achievedAmount / userTargets[key].amount) * 100
                          }%`,
                        }}
                      />
                    </div>
            ...
            : ar.push(
                <div className="column" key={key}>
                  <div className="ui grey inverted progress">
                    <h5>
                      {`${userTargets[key].label}: ${achievedAmount}/${userTargets[key].amount} ${userTargets[key].unitLabel} `}
                    </h5>
                    <div className="bar-wrapper">
